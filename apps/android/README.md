## ZoidbergBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_zoidbergbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm zoidbergbot gateway --port 18789 --verbose
```
