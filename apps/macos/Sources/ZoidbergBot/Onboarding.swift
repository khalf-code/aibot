...
enum UIStrings {
    static let welcomeTitle = "Welcome to ZoidbergBot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "zoidbergbot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ZoidbergBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ZoidbergBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g zoidbergbot@\(version)"
    }
