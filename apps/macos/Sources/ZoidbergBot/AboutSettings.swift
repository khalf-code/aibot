...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/zoidbergbot/zoidbergbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/zoidbergbot/zoidbergbot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://zoidbergbot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "ZoidbergBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "ZoidbergBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ZoidbergBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ZoidbergBotGitCommit") as? String) ??
            "unknown"
    }
