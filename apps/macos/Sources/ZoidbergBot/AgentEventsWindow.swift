...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ZoidbergBotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ZoidbergBotProtocol.AnyCodable("start"),
                "name": ZoidbergBotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
