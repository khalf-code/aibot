...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ZoidbergBotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ZoidbergBotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
