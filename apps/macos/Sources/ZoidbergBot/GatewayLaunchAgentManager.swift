...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".zoidbergbot/disable-launchagent"
