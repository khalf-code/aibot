...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ZoidbergBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ZoidbergBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ZoidbergBotConfigFile.loadDict()
            ...
            ZoidbergBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/zoidbergbot"
        state.remoteCliPath = ""
        return state
    }
}
