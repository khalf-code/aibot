...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (ZoidbergBot token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ZoidbergBotOAuthStore.AnthropicOAuthStatus = ZoidbergBotOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "anthropic-oauth")
...
enum ZoidbergBotOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let openclawOAuthDirEnv = "ZOIDBERGBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "ZoidbergBot OAuth token file not found"
            case .unreadableFile: "ZoidbergBot OAuth token file not readable"
            case .invalidJSON: "ZoidbergBot OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in ZoidbergBot OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "ZoidbergBot OAuth credentials found"
            }
        }
    }
    ...
    static func oauthDir() -> URL {
        ...
        let preferred = home.appendingPathComponent(".zoidbergbot", isDirectory: true)
