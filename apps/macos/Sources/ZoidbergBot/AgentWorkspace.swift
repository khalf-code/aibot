...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ZoidbergBotConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - ZoidbergBot Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.zoidbergbot/zoidbergbot.json
