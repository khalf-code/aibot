...
struct SettingsRootView: View {
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ZoidbergBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ZoidbergBotPaths.stateDirURL.path
