...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ZoidbergBot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__zoidbergbot__/a2ui/").absoluteString + "?platform=macos"
    }
