...
enum ZoidbergBotConfigFile {
    private static let logger = Logger(subsystem: "ai.zoidbergbot", category: "config")
    ...
    static func stateDirURL() -> URL {
        ZoidbergBotPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ZoidbergBotPaths.workspaceURL
    }
