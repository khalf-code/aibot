...
public enum ZoidbergBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct ZoidbergBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ZoidbergBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
