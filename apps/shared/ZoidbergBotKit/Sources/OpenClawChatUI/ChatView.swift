...
@MainActor
public struct ZoidbergBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: ZoidbergBotChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                ZoidbergBotChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [ZoidbergBotChatMessage] {
        let base: [ZoidbergBotChatMessage]
    ...
    private func mergeToolResults(in messages: [ZoidbergBotChatMessage]) -> [ZoidbergBotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ZoidbergBotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ZoidbergBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ZoidbergBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ZoidbergBotChatMessage) -> String {
