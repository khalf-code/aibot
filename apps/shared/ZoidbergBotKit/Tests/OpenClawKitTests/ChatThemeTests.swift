...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = ZoidbergBotChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = ZoidbergBotChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
