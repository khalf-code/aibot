...
import { Target, X, Plus, Trash2, Loader2, ArrowLeft, Sparkles } from "lucide-react";
...
export function CreateGoalModal({
  ...
  const [step, setStep] = React.useState<ModalStep>("template");
  const [selectedTemplate, setSelectedTemplate] =
    React.useState<GoalTemplate | null>(null);
  ...
  const handleTemplateSelect = (template: GoalTemplate) => {
    ...
    setDescription("");
    setMilestones(
      template.milestones.map((m) => ({ id: uuidv7(), title: m }))
    );
    setStep("form");
  };
            ...
            <Dialog.Content asChild>
              <motion.div
                ...
                className={cn(
                  ...
                  step === "template" ? "max-w-2xl" : "max-w-lg",
                    ...
                    >
                      <form onSubmit={handleSubmit}>
                        <div className="p-6 overflow-y-auto max-h-[calc(85vh-180px)] space-y-5">
                          {/* Template badge */}
                          {selectedTemplate && (
                            <div className="flex items-center gap-2 rounded-lg bg-primary/5 border border-primary/10 px-3 py-2 text-sm">
