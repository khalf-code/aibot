/**
 * Device Auth Token Storage for Clawdbrain Web UI.
 *
 * Manages device authentication tokens received from the Gateway
 * for persistent authentication across sessions.
 */
