...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: ZoidbergBotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: ZoidbergBotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: ZoidbergBotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
