...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ZoidbergBotLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while ZoidbergBot is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: ZoidbergBotLocationMode {
        ZoidbergBotLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
