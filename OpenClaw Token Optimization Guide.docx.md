...
_90% Token Discount on Reused Content_
...
| openclaw shell session_status \# Look for cache metrics: \# Cache hits: 45/50 (90%) \# Cache tokens used: 225KB (vs 250KB without cache) \# Cost savings: $0.22 this session |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

Or query the API directly:

| \# Check your usage over 24h curl https://api.anthropic.com/v1/usage \\ \-H "Authorization: Bearer $ANTHROPIC_API_KEY" | jq '.usage.cache' |
| :--------------------------------------------------------------------------------------------------------------------- | ----------------- |
...
| \# Start a session openclaw shell \# Check current status session_status \# You should see: \# \- Context size: 2-8KB (not 50KB+) \# \- Model: Haiku (not Sonnet) \# \- Heartbeat: Ollama/local |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
