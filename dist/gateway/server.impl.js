...
import { startOverseerContinuationBridge, stopOverseerContinuationBridge, } from "../infra/overseer/continuation-bridge.js";
        ...
        startOverseerContinuationBridge({
            ...
            hooks: {
                onTurnIssue: ({ event: _event, assignment, issue }) => {
                    log.debug(`Overseer turn issue: ${issue} for assignment ${assignment?.assignmentId ?? "unknown"}`);
                },
