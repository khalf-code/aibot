...
export const validateOverseerStatusParams = ajv.compile(OverseerStatusParamsSchema);
export const validateOverseerGoalCreateParams = ajv.compile(OverseerGoalCreateParamsSchema);
export const validateOverseerGoalStatusParams = ajv.compile(OverseerGoalStatusParamsSchema);
export const validateOverseerGoalUpdateParams = ajv.compile(OverseerGoalUpdateParamsSchema);
export const validateOverseerWorkUpdateParams = ajv.compile(OverseerWorkUpdateParamsSchema);
export const validateOverseerTickParams = ajv.compile(OverseerTickParamsSchema);
