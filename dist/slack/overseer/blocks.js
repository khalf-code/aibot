...
export function buildActivityBlocks(params) {
...
export function buildEscalationBlocks(params) {
...
export function buildGoalCompletedBlocks(params) {
...
export function buildDecisionBlocks(params) {
...
export function buildDecisionResolvedBlocks(params) {
...
export function buildDecisionExpiredBlocks(params) {
    const { decision } = params;
    const blocks = [
        {
            type: "section",
