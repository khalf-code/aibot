...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: ZoidbergBotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: ZoidbergBotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: ZoidbergBotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: ZoidbergBotConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: ZoidbergBotConfig): void {
