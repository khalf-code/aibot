...
import type { ZoidbergBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ZoidbergBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ZoidbergBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
