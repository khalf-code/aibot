...
describe("hooks install (e2e)", () => {
  ...
  beforeEach(async () => {
    ...
    prevBundledDir = process.env.MOLTBOT_BUNDLED_HOOKS_DIR;
    process.env.MOLTBOT_STATE_DIR = path.join(baseDir, "state");
    process.env.MOLTBOT_BUNDLED_HOOKS_DIR = path.join(baseDir, "bundled-none");
    vi.resetModules();
  });
  ...
  afterEach(async () => {
    ...
    if (prevBundledDir === undefined) {
      ...
      process.env.MOLTBOT_BUNDLED_HOOKS_DIR = prevBundledDir;
    }
