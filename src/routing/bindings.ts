...
export function listBindings(cfg: ZoidbergBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ZoidbergBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ZoidbergBotConfig) {
