...
export function listSlackAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: ZoidbergBotConfig): string {
...
function mergeSlackAccountConfig(cfg: ZoidbergBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ZoidbergBotConfig): ResolvedSlackAccount[] {
