...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.audio.transcription.provider": "Audio Transcription Provider",
  "tools.audio.transcription.model": "Audio Transcription Model",
  "tools.audio.transcription.language": "Audio Transcription Language",
  "tools.audio.transcription.prompt": "Audio Transcription Prompt",
  "tools.audio.transcription.enabled": "Enable Audio Transcription",
  "tools.audio.transcription.maxBytes": "Audio Transcription Max Bytes",
  "tools.audio.transcription.profile": "Audio Transcription Profile",
  "tools.audio.transcription.preferredProfile": "Audio Transcription Preferred Profile",
  "tools.audio.transcription.scope": "Audio Transcription Scope",
  "tools.video.understanding.enabled": "Enable Video Understanding",
  "tools.video.understanding.provider": "Video Understanding Provider",
  "tools.video.understanding.model": "Video Understanding Model",
  "tools.video.understanding.prompt": "Video Understanding Prompt",
  "tools.video.understanding.timeoutSeconds": "Video Understanding Timeout (sec)",
  "tools.video.understanding.maxBytes": "Video Understanding Max Bytes",
  "tools.video.understanding.profile": "Video Understanding Profile",
  "tools.video.understanding.preferredProfile": "Video Understanding Preferred Profile",
  "tools.video.understanding.scope": "Video Understanding Scope",
