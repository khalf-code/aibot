import type { ZoidbergBotConfig } from "./config.js";
...
function isTelegramConfigured(cfg: ZoidbergBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ZoidbergBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ZoidbergBotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ZoidbergBotConfig): boolean {
...
function isIMessageConfigured(cfg: ZoidbergBotConfig): boolean {
...
function isWhatsAppConfigured(cfg: ZoidbergBotConfig): boolean {
...
function isGenericChannelConfigured(cfg: ZoidbergBotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ZoidbergBotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ZoidbergBotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ZoidbergBotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ZoidbergBotConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: ZoidbergBotConfig, pluginId: string): ZoidbergBotConfig {
...
function enablePluginEntry(cfg: ZoidbergBotConfig, pluginId: string): ZoidbergBotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
