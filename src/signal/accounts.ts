...
export function listSignalAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ZoidbergBotConfig): string {
...
function mergeSignalAccountConfig(cfg: ZoidbergBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ZoidbergBotConfig): ResolvedSignalAccount[] {
