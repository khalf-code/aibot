...
const SANDBOX_EXAMPLES = {
  main: [
    ["zoidbergbot sandbox list", "List all sandbox containers."],
    ["zoidbergbot sandbox list --browser", "List only browser containers."],
    ["zoidbergbot sandbox recreate --all", "Recreate all containers."],
    ["zoidbergbot sandbox recreate --session main", "Recreate a specific session."],
    ["zoidbergbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["zoidbergbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["zoidbergbot sandbox list", "List all sandbox containers."],
    ["zoidbergbot sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["zoidbergbot sandbox recreate --session main", "Recreate a specific session."],
    [
      "zoidbergbot sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["zoidbergbot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["zoidbergbot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["zoidbergbot sandbox explain", "Show effective sandbox config."],
    ["zoidbergbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["zoidbergbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["zoidbergbot sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.zoidbergbot.ai/cli/sandbox")}\n`,
    )
    .action(() => {
