...
export function resolveTtsConfig(cfg: ZoidbergBotConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.ZOIDBERGBOT_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: ZoidbergBotConfig): string | undefined {
