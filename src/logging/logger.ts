...
export const DEFAULT_LOG_DIR = "/tmp/zoidbergbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "zoidbergbot.log"); // legacy single-file path

const LOG_PREFIX = "zoidbergbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ZoidbergBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ZoidbergBotConfig;
      };
