...
export function applyZaiConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyOpenrouterConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyMoonshotProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applySyntheticProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyXiaomiProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
