...
function resolveDefaultAccountId(cfg: ZoidbergBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ZoidbergBotConfig): boolean {
...
export function summarizeBindings(cfg: ZoidbergBotConfig, bindings: AgentBinding[]): string[] {
