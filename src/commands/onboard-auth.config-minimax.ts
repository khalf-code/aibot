...
export function applyMinimaxProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyMinimaxConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
