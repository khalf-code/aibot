...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "zoidbergbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ZoidbergBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ZoidbergBotConfig["telegram"]>>,
