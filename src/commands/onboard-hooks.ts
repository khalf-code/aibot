...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.zoidbergbot.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("zoidbergbot hooks list")}`,
      `  ${formatCliCommand("zoidbergbot hooks enable <name>")}`,
      `  ${formatCliCommand("zoidbergbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
