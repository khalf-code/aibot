...
export function summarizeExistingConfig(config: ZoidbergBotConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.zoidbergbot.ai/gateway/remote",
    "https://docs.zoidbergbot.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
