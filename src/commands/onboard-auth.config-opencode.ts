...
export function applyOpencodeZenProviderConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyOpencodeZenConfig(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
