...
function resolveConfiguredModelRaw(cfg: ZoidbergBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: ZoidbergBotConfig): string[] {
...
export function applyPrimaryModel(cfg: ZoidbergBotConfig, model: string): ZoidbergBotConfig {
...
export function applyModelAllowlist(cfg: ZoidbergBotConfig, models: string[]): ZoidbergBotConfig {
  const defaults = cfg.agents?.defaults;
