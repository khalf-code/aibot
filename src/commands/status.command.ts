...
export async function statusCommand(
  ...
  runtime.log(theme.heading("ZoidbergBot status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("zoidbergbot security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("zoidbergbot security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.zoidbergbot.ai/faq");
  runtime.log("Troubleshooting: https://docs.zoidbergbot.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("zoidbergbot status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("zoidbergbot logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("zoidbergbot status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("zoidbergbot gateway probe")}`);
  }
}
