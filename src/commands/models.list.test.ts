...
const ensureZoidbergBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveZoidbergBotAgentDir = vi.fn().mockReturnValue("/tmp/zoidbergbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/zoidbergbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureZoidbergBotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveZoidbergBotAgentDir,
}));
