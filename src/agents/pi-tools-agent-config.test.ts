...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: ZoidbergBotConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/zoidbergbot-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createZoidbergBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createZoidbergBotCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createZoidbergBotCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createZoidbergBotCodingTools({
      config: cfg,
    ...
    const bobTools = createZoidbergBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createZoidbergBotCodingTools({
      config: cfg,
