...
describe("createZoidbergBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createZoidbergBotCodingTools({
      config,
    ...
    const anthropicTools = createZoidbergBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createZoidbergBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createZoidbergBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
