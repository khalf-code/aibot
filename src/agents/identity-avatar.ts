...
function resolveAvatarSource(cfg: ZoidbergBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ZoidbergBotConfig, agentId: string): AgentAvatarResolution {
