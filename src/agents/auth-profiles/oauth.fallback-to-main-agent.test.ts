...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveZoidbergBotAgentDir() returns mainAgentDir
    process.env.ZOIDBERGBOT_STATE_DIR = tmpDir;
    process.env.ZOIDBERGBOT_AGENT_DIR = mainAgentDir;
