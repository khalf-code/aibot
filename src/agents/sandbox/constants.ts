...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".zoidbergbot", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "zoidbergbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "zoidbergbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "zoidbergbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "zoidbergbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "zoidbergbot-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".zoidbergbot");
