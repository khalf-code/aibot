...
function resolveWatchPaths(workspaceDir: string, config?: ZoidbergBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ZoidbergBotConfig }) {
