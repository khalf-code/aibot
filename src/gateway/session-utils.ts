...
function listConfiguredAgentIds(cfg: ZoidbergBotConfig): string[] {
...
export function listAgentsForGateway(cfg: ZoidbergBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ZoidbergBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: ZoidbergBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ZoidbergBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ZoidbergBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ZoidbergBotConfig): GatewaySessionsDefaults {
