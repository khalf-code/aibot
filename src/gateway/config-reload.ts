...
import type { ZoidbergBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: ZoidbergBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: ZoidbergBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ZoidbergBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ZoidbergBotConfig) => void;
  log: {
