...
export type ChannelAgentToolFactory = (params: { cfg?: ZoidbergBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ZoidbergBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ZoidbergBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ZoidbergBotConfig }) => boolean;
  supportsCards?: (params: { cfg: ZoidbergBotConfig }) => boolean;
