...
import type { ZoidbergBotPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverZoidbergBotPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ZoidbergBotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["ZOIDBERGBOT_PLUGIN_CATALOG_PATHS", "ZOIDBERGBOT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ZoidbergBotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ZoidbergBotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ZoidbergBotPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverZoidbergBotPlugins({ workspaceDir: options.workspaceDir });
