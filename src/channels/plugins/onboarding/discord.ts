...
function setDiscordDmPolicy(cfg: ZoidbergBotConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: ZoidbergBotConfig, allowFrom: string[]): ZoidbergBotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
