...
import type { GatewayBindMode, GatewayTailscaleMode, ZoidbergBotConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      [
        "Docs:",
        "https://docs.zoidbergbot.ai/gateway/tailscale",
        "https://docs.zoidbergbot.ai/web",
      ].join("\n"),
      "Tailscale",
    );
