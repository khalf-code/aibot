...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ZOIDBERGBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ZoidbergBotConfig): string {
...
export function listEnabledTelegramAccounts(cfg: ZoidbergBotConfig): ResolvedTelegramAccount[] {
