...
export const normalizePluginsConfig = (
  config?: ZoidbergBotConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: ZoidbergBotConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ZoidbergBotConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: ZoidbergBotConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
