...
import {
  ...
  type ZoidbergBotPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @zoidbergbot/voice-call -> voice-call).
...
export function discoverZoidbergBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".zoidbergbot", "extensions")];
