...
export const DEFAULT_MEMORY_FLUSH_PROMPT = [
  ...
  "Optional WM/STM/LTM layout: if STM.md / WORKING.md / ltm/ are missing, create them (STM.md, WORKING.md, ltm/index.md, ltm/nodes/), then update them.",
  "Keep STM.md short (rolling cache); keep ltm/ high-level (index.md + a few nodes); WORKING.md is a projection and should stay small.",
...
export const DEFAULT_MEMORY_FLUSH_SYSTEM_PROMPT = [
  ...
  "Create STM.md/WORKING.md/ltm/ if missing; if you cannot, use MEMORY.md + memory/ instead.",
