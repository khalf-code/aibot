...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ZoidbergBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ZoidbergBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: ZoidbergBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
