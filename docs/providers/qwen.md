---
summary: "Use Qwen OAuth (free tier) in ZoidbergBot"
read_when:
  - You want to use Qwen with ZoidbergBot
...
If you already logged in with the Qwen Code CLI, ZoidbergBot will sync credentials
