---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ZoidbergBot"
read_when:
  - You want Xiaomi MiMo models in ZoidbergBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ZoidbergBot uses
