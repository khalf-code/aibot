...
You can point ZoidbergBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ZoidbergBot
...
- [Anthropic provider](/providers/anthropic) - Native ZoidbergBot integration with Claude setup-token or API keys
