...
- Install via CLI: `zoidbergbot plugins install @zoidbergbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `zoidbergbot plugins install ./extensions/zalo`
   - From npm (if published): `zoidbergbot plugins install @zoidbergbot/zalo`
...
- Example: `zoidbergbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `zoidbergbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `zoidbergbot logs --follow`
