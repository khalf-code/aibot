...
Tlon is a decentralized messenger built on Urbit. ZoidbergBot connects to your Urbit ship and can
...
Use these with `zoidbergbot message send` or cron delivery:
...
- Thread replies: if the inbound message is in a thread, ZoidbergBot replies in-thread.
