...
ZoidbergBot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ZoidbergBot also aligns
the install method:
...
When you switch channels with `zoidbergbot update`, ZoidbergBot also syncs plugin sources:
