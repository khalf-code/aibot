...
read_when:
  - You are building a ZoidbergBot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (zoidbergbot.plugin.json)

Every plugin **must** ship a `zoidbergbot.plugin.json` file in the **plugin root**.
ZoidbergBot uses this manifest to validate configuration **without executing plugin
