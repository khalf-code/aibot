---
summary: "CLI reference for `zoidbergbot browser` (profiles, tabs, actions, extension relay)"
read_when:
  - You use `zoidbergbot browser` and want examples for common tasks
...
Manage ZoidbergBot’s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
...
- `zoidbergbot`: launches/attaches to a dedicated ZoidbergBot-managed Chrome instance (isolated user data dir).
