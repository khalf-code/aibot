...
ZoidbergBot has two separate “streaming” layers:
...
When block streaming is enabled, ZoidbergBot can **merge consecutive block chunks**
...
When draft streaming is active, ZoidbergBot disables block streaming for that reply to avoid double-streaming.
