...
- Turn delivery on:
  ...
  - or start with `zoidbergbot tui --deliver`
...
- Check the Gateway logs: `zoidbergbot logs --follow`.
- Confirm the agent can run: `zoidbergbot status` and `zoidbergbot models status`.
...
- No agents in picker: check `zoidbergbot agents list` and your routing config.
