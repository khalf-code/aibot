...
#
# Output:
# - dist/ZoidbergBot.app
# - dist/ZoidbergBot-<version>.zip
# - dist/ZoidbergBot-<version>.dmg
...
APP="$ROOT_DIR/dist/ZoidbergBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ZoidbergBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/ZoidbergBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ZoidbergBot-$VERSION.notary.zip"
