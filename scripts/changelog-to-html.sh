...
if [[ -z "$version_content" ]]; then
  echo "<h2>ZoidbergBot $VERSION</h2>"
  echo "<p>Latest ZoidbergBot update.</p>"
  echo "<p><a href=\"https://github.com/zoidbergbot/zoidbergbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
