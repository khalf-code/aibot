...
export function listZalouserAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ZoidbergBotConfig): string {
...
function mergeZalouserAccountConfig(cfg: ZoidbergBotConfig, accountId: string): ZalouserAccountConfig {
