...
function setMSTeamsDmPolicy(cfg: ZoidbergBotConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: ZoidbergBotConfig, allowFrom: string[]): ZoidbergBotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
