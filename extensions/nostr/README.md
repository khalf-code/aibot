...
Nostr DM channel plugin for ZoidbergBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ZoidbergBot. It enables your bot to:
...
# Configure zoidbergbot to use local relay
