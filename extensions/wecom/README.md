...
## 📚 Ops / Troubleshooting Docs

- `docs/remote-ops-troubleshooting.md`: notes and fixes for remote-ops / sandbox paths / jumper
- `docs/wecom-workspace-skill-setup.md`: WeCom-only user setup runbook (skill env/SSH keys) + options to ensure new dynamic-agent workspaces include the guiding MD files
