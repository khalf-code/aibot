import type { LineChannelData, ZoidbergBotPluginApi, ReplyPayload } from "zoidbergbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ZoidbergBotPluginApi): void {
  api.registerCommand({
    name: "card",
