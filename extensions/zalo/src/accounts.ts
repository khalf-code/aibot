...
export function listZaloAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: ZoidbergBotConfig): string {
...
function mergeZaloAccountConfig(cfg: ZoidbergBotConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ZoidbergBotConfig): ResolvedZaloAccount[] {
