import type { ChannelOnboardingAdapter, ZoidbergBotConfig, WizardPrompter } from "zoidbergbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.zoidbergbot.ai/channels/mattermost",
    ].join("\n"),
