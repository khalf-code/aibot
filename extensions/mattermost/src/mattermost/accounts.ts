...
export function listMattermostAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ZoidbergBotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ZoidbergBotConfig): ResolvedMattermostAccount[] {
