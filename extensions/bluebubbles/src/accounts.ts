...
export function listBlueBubblesAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ZoidbergBotConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ZoidbergBotConfig): ResolvedBlueBubblesAccount[] {
